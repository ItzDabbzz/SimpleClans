...
public final class Request {
     ...
     * @param target
     */
    public Request( CookClans plugin, ClanRequest type, List<ClanPlayer> acceptors, ClanPlayer requester, String target, Clan clan, String msg) {
        this.type = type;
        this.target = target;
        this.clan = clan;
        this.msg = msg;
    ...
    public boolean reachedRequestLimit() {
        return askCount > CookClans.getInstance().getSettingsManager().getMaxAsksPerRequest();
    }
}
