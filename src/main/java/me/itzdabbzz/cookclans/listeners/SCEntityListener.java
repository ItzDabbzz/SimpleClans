...
import me.itzdabbzz.cookclans.Kill;
import me.itzdabbzz.cookclans.CookClans;
import me.itzdabbzz.cookclans.managers.StorageManager.DataCallback;
import me.itzdabbzz.cookclans.Kill.Type;
...
public class SCEntityListener implements Listener
{
    ...
    public void onEntityDeath(EntityDeathEvent event)
    {
        if (event.getEntity() instanceof Player)
        {
            ...
            {
            	if ( CookClans.getInstance().getSettingsManager().isDenySameIPKills())
            	{
