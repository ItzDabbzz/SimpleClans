...
public class ClanPlayer implements Serializable, Comparable<ClanPlayer>
{
    ...
    public ClanPlayer(UUID playerUniqueId)
    {
        ...
        Player OnlinePlayer = CookClans.getInstance().getServer().getPlayer(playerUniqueId);
        if (OnlinePlayer != null)
        {
            this.displayName = OnlinePlayer.getName();
        } else
        {
            OfflinePlayer OfflinePlayer = CookClans.getInstance().getServer().getOfflinePlayer(playerUniqueId);
    ...
    {
        ClanPlayer allycp = CookClans.getInstance().getClanManager().getClanPlayer(player);
    ...
    public String getLastSeenDaysString()
    {
        ...
        if (days < 1)
        {
            return CookClans.getInstance().getLang("today");
        }
        else if (Math.round(days) == 1)
        {
            return MessageFormat.format( CookClans.getInstance().getLang("1.color.day"), ChatColor.GRAY);
        }
        else
        {
            return MessageFormat.format( CookClans.getInstance().getLang("many.color.days"), Math.round(days), ChatColor.GRAY);
        }
    }
    ...
    public String getPastClansString(String sep)
    {
        ...
        if (out.trim().isEmpty())
        {
            return CookClans.getInstance().getLang("none");
        }
...
//        return pc;
    ...
    public void setResignTimes(Map<String, Long> resignTimes) {
    	if (resignTimes != null) {
    		final int cooldown = CookClans.getInstance().getSettingsManager().getRejoinCooldown();
    ...
    public void setBbEnabled(boolean bbEnabled)
    {
        ...
        CookClans.getInstance().getStorageManager().updateClanPlayer(this);
    }
    ...
    public void setTagEnabled(boolean tagEnabled)
    {
        ...
        CookClans.getInstance().getStorageManager().updateClanPlayer(this);
        CookClans.getInstance().getClanManager().updateDisplayName(this.toPlayer());
    }
    ...
    public Player toPlayer()
    {
        ...
        {
            return CookClans.getInstance().getServer().getPlayer(this.uniqueId);
        } else
        {
            return CookClans.getInstance().getServer().getPlayer(this.displayName);
        }
    }
