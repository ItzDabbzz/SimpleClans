package me.itzdabbzz.cookclans.storage;
...
import me.itzdabbzz.cookclans.threads.ThreadUpdateSQL;
...
public class MySQLCore implements DBCore {
    ...
    public void insert(String query) {
        if ( CookClans.getInstance().getSettingsManager().getUseThreads()) {
